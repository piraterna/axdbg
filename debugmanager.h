...
struct Variable {
    ...
    static Variable parseMap(const QMap<QString, QVariant>& data);
};
...
struct Frame {
    ...
    static Frame parseMap(const QMap<QString, QVariant>& data);
};
...
struct Breakpoint {
    ...
    static Breakpoint parseMap(const QMap<QString, QVariant>& data);
};
...
struct Thread {
    ...
    static Thread parseMap(const QMap<QString, QVariant>& data);
};
